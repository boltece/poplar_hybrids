...
# # Isolation-with-migration (i.e., a recurring gene flow model)



pts_1 = [250,260,270]

def GF(params, ns, pts):
	nuB, nuT, T1, m12, m21 = params
	"""
	2-populations,  model with recurring gene flow.

	nuB:  Current size of balsam population, after split.
	nuT:  Current size of coastal tricho population.
	m12: gene flow rate from coastal tricho into balsamifera
	m21: gene flow rate from balsamifera into coastal tricho
	T1:   Divergence time for split between balsam and tricho 
...
lower_bound = [1e-4,1e-4, 1e-4, 1e-3, 1e-3]
p0 = array([0.1,0.1, 0.1, 1, 1])
...
matplotlib.pyplot.savefig("GF_unfolded_run1.pdf")
