...
# # Secondary contact  model (SC)


pts_1 = [250,260,270]

def SC(params, ns, pts):
	nuB, nuT, T1,T2, m12, m21 = params
	"""
	...
	m12: gene flow rate from coastal tricho into balsam
	m21: gene flow rate from balsam into coastal tricho
	T1:   Divergence time for split between balsam and tricho with no gene flow
...
upper_bound = [10, 10, 0.1, 0.1, 100, 100]
lower_bound = [1e-4,1e-4, 1e-5,1e-5, 1e-3, 1e-3]
p0 = array([0.1,0.1, 0.001, 0.001, 1, 1])
...
matplotlib.pyplot.savefig("SC_unfolded.pdf")
